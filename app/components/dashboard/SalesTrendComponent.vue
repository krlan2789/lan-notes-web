...
import type { IChartData } from '~/shared/interfaces/IChartData';
import type { IChartOption } from '~/shared/interfaces/IChartOption';

const { primary, surface, isDarkMode } = useLayout();

const chartData = ref<IChartData | undefined>();
const chartOptions = ref<IChartOption | undefined>();

function setChartData(): IChartData {
...
function setChartOptions(): IChartOption {
	return {
