...
<template>
	<InputGroup>
		...
		<InputText @input="() => props.onSearch?.(keyword)" v-model="keyword" placeholder="Find notes" :value="keyword"
			class="bg-surface-100 text-surface-700" fluid :autofocus="autofocus"></InputText>
		<!-- <InputGroupAddon>
